...
from config_screen_validation import SCREEN_DEFINITIONS, SCREEN_VALIDATION_CONFIG
...
def capture_screenshot_ssh(device_ip: str, port: int, username: str, password: str) -> Optional[str]:
    ...
    try:
        ...
        import requests
        from config_screenshot import rpc_url, upload_base_url, download_base_url, screenshot_upload_timeout, screenshot_download_timeout
        from screenshot_utils import activate_screencapture_plugin
