...
class TestExecutionService:
    ...
    def add_result(self, iteration: int, phase: str, status: str, details: str,
        ...
        print(f"[DEBUG] Saving result for job_id={job_id}, device_ip={result_device_ip}, iteration={iteration}, phase={phase}, status={status}")
        ...
        try:
            ...
            print(f"[DEBUG] Result persisted for job_id={job_id}, iteration={iteration}")
        except Exception as e:
            import traceback
            error_trace = traceback.format_exc()
