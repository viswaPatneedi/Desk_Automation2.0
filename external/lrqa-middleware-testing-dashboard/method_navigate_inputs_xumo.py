...
from screenshot_utils_vnc import take_vnc_screenshot_with_fallback, normalize_screenshot_path
from datetime import datetime, timezone
from config_commands import power_key_command, home_key_command, enter_key_command, down_key_command, right_key_command
...
def validate_input_tile_with_reference(screenshot_path, input_name, reference_dir, log_func):
    ...
    Uses LightweightScreenValidator for comparison if available.
    """
