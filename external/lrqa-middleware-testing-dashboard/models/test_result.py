...
class TestResult:
    ...
    def __init__(self, iteration: int, phase: str, status: str, details: str,
        ...
        self.device_name = device_name  # ← NEW: Device name for display
        self.method = method
    ...
    def to_dict(self) -> Dict:
        ...
        return {
            ...
            'device_name': self.device_name,  # ← NEW: Device name for display
            'method': self.method,
    ...
    def from_dict(cls, data: Dict) -> 'TestResult':
        ...
        return cls(
            ...
            device_name=data.get('device_name'),  # ← NEW: Device name
